...
function mgt_shortcode_counter_wp($atts, $sc_content = null) {
	...
	echo '<div class="mgt-counter-wrapper mgt-counter-icon-position-'.esc_attr($icon_position).' wpb_content_element text-'.esc_attr($color).' text-font-weight-'.esc_attr($fontweight).' text-'.esc_attr($align).esc_attr($animation_css_class).'">';

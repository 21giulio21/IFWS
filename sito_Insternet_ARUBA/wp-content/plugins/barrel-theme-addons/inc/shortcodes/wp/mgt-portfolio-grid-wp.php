...
function mgt_shortcode_portfolio_grid_wp($atts, $content = null) {
	...
	$porfolio_image_size = 'barrel-portfolio-thumb-square'; // 1024 by default

	if(($slider_columns < 3) || ($columns < 3)) {
		$porfolio_image_size = 'barrel-portfolio-large'; // 1600x800
	}
	...
	if(!$wp_query->have_posts()) {
		esc_html_e('You does not have projects to display for current MGT Portfolio Grid element settings.', 'barrel');
	}

...
function mgt_shortcode_flipbox_wp($atts, $sc_content = null) {
	...
	$background_image_front_data = wp_get_attachment_image_src( $background_image_front, 'barrel-blog-thumb' );
	...
	$background_image_back_data = wp_get_attachment_image_src( $background_image_back, 'barrel-blog-thumb' );

...
add_action( 'wp_loaded', 'barrel_visual_composer_custom_init' );

function barrel_visual_composer_custom_init() {
...
add_action( 'init', 'barrel_addons_shortcodes_init', 9999 );

function barrel_addons_shortcodes_init() {
...
// [barrel_social_icons] - Show theme social icons with links
function barrel_social_icons_shortcode( $atts ) {
	ob_start();
	
	echo '<div class="widget_barrel_social_icons shortcode_barrel_social_icons">';
...
add_shortcode( 'barrel_social_icons', 'barrel_social_icons_shortcode' );

// WordPress AutoP fix for theme shortcodes
add_filter("the_content", "barrel_the_content_filter");

function barrel_the_content_filter($content) {

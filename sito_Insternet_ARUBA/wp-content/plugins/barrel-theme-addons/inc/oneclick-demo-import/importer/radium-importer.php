 ...
 if ( !class_exists( 'Radium_Theme_Importer' ) ) {
	...
	class Radium_Theme_Importer {
			...
			?>
			 ...
			 <div class="theme-demo-import-items">
				 ...
				 <div class="theme-demo-import-item">
					 ...
					 <a class="theme-live-preview button button-primary" href="http://wp.magnium-themes.com/barrel/barrel-1/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 ...
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.magnium-themes.com/barrel/barrel-2/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="3">Demo 3 - Agency<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/3/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.magnium-themes.com/barrel/barrel-3/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="4">Demo 4 - Startup<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/4/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.magnium-themes.com/barrel/barrel-4/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="5">Demo 5 - SEO<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/5/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.magnium-themes.com/barrel/barrel-5/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="6">Demo 6 - eCommerce<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/6/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.magnium-themes.com/barrel/barrel-6/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="7">Demo 7 - Minimal Portfolio<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/7/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.magnium-themes.com/barrel/barrel-7/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="8">Demo 8 - App Landing<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/8/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.magnium-themes.com/barrel/barrel-8/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="9">Demo 9 - Company<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/9/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.magnium-themes.com/barrel/barrel-9/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="10">Demo 10 - Onepage<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/10/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.magnium-themes.com/barrel/barrel-10/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="11">Demo 11 - Portfolio<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/11/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.magnium-themes.com/barrel/barrel-11/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="12">Demo 12 - Restaurant<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/12/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.magnium-themes.com/barrel/barrel-12/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="13">Demo 13 - Photography<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/13/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.magnium-themes.com/barrel/barrel-13/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="14">Demo 14 - Personal<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/14/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.magnium-themes.com/barrel/barrel-14/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="15">Demo 15 - Construction<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/15/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.magnium-themes.com/barrel/barrel-15/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="16">Demo 16 - Consulting<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/16/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.magnium-themes.com/barrel/barrel-16/" target="_blank">Live preview</a>
					 </div>
				 </div>
	    ...
	    public function demo_installer() {
	        ...
	        <h2>One Click Barrel Theme Demo Data import</h2>
			
			<?php if((get_option( 'barrel_license_key_status', false ) !== 'activated')&&(!defined('ENVATO_HOSTED_SITE'))): ?>
			...
			<div class="radium-importer-wrap">
		        <div class="theme-important-notice">
			 	<p>Please register your purchase to import theme demos, get themes updates notifications and get access to premium dedicated support. Theme registration is free and will take just 30 seconds.</p>
	          	...
	          	<a href="themes.php?page=ipanel_BARREL_PANEL" class="button button-hero button-primary">Theme registration</a>
	          	<br/><br/>
				</div>
			</div>

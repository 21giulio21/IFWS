<?php
	...
	add_action( 'wp_enqueue_scripts', 'barrel_enqueue_dynamic_styles', '999' );

    if (!function_exists('barrel_enqueue_dynamic_styles')) :
	function barrel_enqueue_dynamic_styles( ) {
...
", "\n", "  ", "   ", ), array( "", "", " ", " ", " ", ), $out );
    ...
    if (!function_exists('barrel_get_css')) :
	function barrel_get_css () {
		$barrel_theme_options = barrel_get_theme_options();
		// ===
		ob_start();
    ?>
    ...
    if ( defined('DEMO_MODE') && isset($_GET['header_height']) ) {
      $barrel_theme_options['header_height'] = $_GET['header_height'];
    }

    if(isset($barrel_theme_options['header_height']) && $barrel_theme_options['header_height'] > 0) {
        $header_height = $barrel_theme_options['header_height'];
    } else {
        $header_height = 110;
    } 
    ?>
    ...
    header .logo-link img {
        width: <?php if(isset($barrel_theme_options['logo_width'])) { echo intval($barrel_theme_options['logo_width']); } else { echo '179'; } ?>px;
    }
    header.fixed:not(.top-menu-position-header) .logo-link > img {
        max-width: <?php if(isset($barrel_theme_options['logo_width'])) { echo intval($barrel_theme_options['logo_width']); } else { echo '179'; } ?>px;
    }
    <?php
    // Custom footer paddings
    if(isset($barrel_theme_options['footer_paddings']) && $barrel_theme_options['footer_paddings'] !== ''):
    ?>
    footer {
        padding: <?php echo esc_html($barrel_theme_options['footer_paddings']); ?>;
    }
    <?php
    endif;
    ?>
    ...
    if(isset($barrel_theme_options['responsive_tablet_headerinfotext_disable']) && $barrel_theme_options['responsive_tablet_headerinfotext_disable']):
    ?>
    .header-info-text {
        display: none;
    }
    <?php endif; ?>
    <?php
    if(isset($barrel_theme_options['responsive_tablet_headertopmenutext_disable']) && $barrel_theme_options['responsive_tablet_headertopmenutext_disable']):
    ?>
    ...
    if(isset($barrel_theme_options['responsive_mobile_headerinfotext_disable']) && $barrel_theme_options['responsive_mobile_headerinfotext_disable']):
    ?>
    .header-info-text {
        display: none;
    }
    <?php endif; ?>
    <?php
    if(isset($barrel_theme_options['responsive_mobile_headertopmenutext_disable']) && $barrel_theme_options['responsive_mobile_headertopmenutext_disable']):
    ?>
    .header-menu-bg .header-menu .header-top-text {
        display: none;
    }
    ...
    <?php endif; ?>
    <?php
    if(isset($barrel_theme_options['responsive_mobile_headeradvmenutoggle_disable']) && $barrel_theme_options['responsive_mobile_headeradvmenutoggle_disable']):
    ?>
    ...
    <?php endif; ?>
    <?php
    if(isset($barrel_theme_options['responsive_mobile_logo_width']) && $barrel_theme_options['responsive_mobile_logo_width'] !== ''):
    ?>
    header .logo-link img {
        width: <?php echo esc_attr($barrel_theme_options['responsive_mobile_logo_width']);?>px;
    }
    <?php endif; ?>
    }
    ...
    * Custom CSS
    **/
    <?php if(isset($barrel_theme_options['custom_css_code'])) { 

        echo wp_strip_all_tags($barrel_theme_options['custom_css_code']); // This variable contains user Custom CSS code and can't be escaped with WordPress functions
    } 
    ?>
    ...
    **/
    <?php 
        ...
        if(isset($barrel_theme_options['font_google_disable']) && $barrel_theme_options['font_google_disable']) {

            $barrel_theme_options['body_font']['font-family'] = $barrel_theme_options['font_regular'];
            $barrel_theme_options['header_font']['font-family'] = $barrel_theme_options['font_regular'];
            $barrel_theme_options['additional_font']['font-family'] = $barrel_theme_options['font_regular'];
            $barrel_theme_options['buttons_font']['font-family'] = $barrel_theme_options['font_regular'];
        }

        // Logo text font
        if(isset($barrel_theme_options['logo_text_enable']) && $barrel_theme_options['logo_text_enable'] && isset($barrel_theme_options['logo_text_font'])) {

            switch ($barrel_theme_options['logo_text_font']) {
                case 'body':
                    $logo_text_font = $barrel_theme_options['body_font']['font-family'];
                    break;

                case 'header':
                    $logo_text_font = $barrel_theme_options['header_font']['font-family'];
                    break;

                case 'additional':
                    $logo_text_font = $barrel_theme_options['additional_font']['font-family'];
                    break;
            }
        ...
        if(isset($barrel_theme_options['body_font_weight']) && $barrel_theme_options['body_font_weight'] !== '') {
            ?>
            body {
                font-weight: <?php echo esc_attr($barrel_theme_options['body_font_weight']); ?>;
            }
            <?php
        }

        // Font weight overrides header_font_weight
        if(isset($barrel_theme_options['header_font_weight']) && $barrel_theme_options['header_font_weight'] !== '') {
            ?>
            h1, h2, h3, h4, h5, h6,
            .page-item-title h1,
            .mgt-header-block .mgt-header-block-title {
                font-weight: <?php echo esc_attr($barrel_theme_options['header_font_weight']); ?>;
            }
            <?php
        }

        // Font weight overrides widget_title_font_weight
        if(isset($barrel_theme_options['widget_title_font_weight']) && $barrel_theme_options['widget_title_font_weight'] !== '') {
            ?>
            .sidebar .widgettitle,
            .footer-sidebar h2.widgettitle {
                font-weight: <?php echo esc_attr($barrel_theme_options['widget_title_font_weight']); ?>;
            }
            <?php
        }

        // Font size overrides widget_title_font_weight
        if(isset($barrel_theme_options['page_title_font_size']) && $barrel_theme_options['page_title_font_size'] !== '') {
            ?>
            .page-item-title h1 {
                font-size: <?php echo esc_attr($barrel_theme_options['page_title_font_size']); ?>;
            }
            <?php
        }
    ...
    ?>
    h1, h2, h3, h4, h5, h6 {
        font-family: '<?php echo esc_attr($barrel_theme_options['header_font']['font-family']); ?>';
    }
    a.btn,
    .btn,
    .btn:focus,
    ...
    .woocommerce-page a.added_to_cart {
        font-family: '<?php echo esc_attr($barrel_theme_options['buttons_font']['font-family']); ?>';
    }
    ...
    body {
        font-family: '<?php echo esc_attr($barrel_theme_options['body_font']['font-family']); ?>';
        font-size: <?php echo esc_attr($barrel_theme_options['body_font']['font-size']); ?>px;
    }
    <?php if(isset($barrel_theme_options['additional_font_enable']) && $barrel_theme_options['additional_font_enable']): ?>
    .mgt-promo-block .mgt-promo-block-content strong,
    .barrel-slide strong {
        font-family: '<?php echo esc_attr($barrel_theme_options['additional_font']['font-family']); ?>';
    }
    <?php endif; ?>
    /**
    ...
    */
    ...
    if ( defined('DEMO_MODE') && isset($_GET['color_skin_name']) ) {
      $barrel_theme_options['color_skin_name'] = $_GET['color_skin_name'];
    }

    if(!isset($barrel_theme_options['color_skin_name'])) {
        $color_skin_name = 'none';
    }
    else {
        $color_skin_name = $barrel_theme_options['color_skin_name'];
    }
    // Use panel settings
    if($color_skin_name == 'none') {

        $theme_body_color = $barrel_theme_options['theme_body_color'];
        $theme_text_color = $barrel_theme_options['theme_text_color'];
        $theme_main_color = $barrel_theme_options['theme_main_color'];
        $theme_header_bg_color = $barrel_theme_options['theme_header_bg_color'];
        $theme_top_menu_bg_color = $barrel_theme_options['theme_top_menu_bg_color'];
        $theme_top_menu_color = $barrel_theme_options['theme_top_menu_color'];
        $theme_main_menu_bg_color = $barrel_theme_options['theme_main_menu_bg_color'];
        $theme_main_menu_dark_bg_color = $barrel_theme_options['theme_main_menu_dark_bg_color'];
        $theme_footer_sidebar_bg_color = $barrel_theme_options['theme_footer_sidebar_bg_color'];
        $theme_footer_sidebarlight_bg_color = $barrel_theme_options['theme_footer_sidebarlight_bg_color'];
        $theme_footer_bg_color = $barrel_theme_options['theme_footer_bg_color'];
        $theme_footerlight_bg_color = $barrel_theme_options['theme_footerlight_bg_color'];
        $theme_title_color = $barrel_theme_options['theme_title_color'];
        $theme_titlebg_color = $barrel_theme_options['theme_titlebg_color'];

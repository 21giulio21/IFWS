...
if ( defined('DEMO_MODE') && isset($_GET['blog_sidebar_position']) ) {
  $barrel_theme_options['blog_sidebar_position'] = $_GET['blog_sidebar_position'];
}
...
$blog_sidebarposition = $barrel_theme_options['blog_sidebar_position'];
...
// Blog page title
if(isset($barrel_theme_options['blog_page_title'])) {
	$blog_page_title = $barrel_theme_options['blog_page_title'];
} else {
	$blog_page_title = esc_html__('News', 'barrel');
}

// Blog page title background image
if(isset($barrel_theme_options['blog_page_title_image']) && $barrel_theme_options['blog_page_title_image'] <> '') {
  $header_background_image_style = 'background-image: url('.$barrel_theme_options['blog_page_title_image'].');';
  $header_background_class = ' with-bg';

  // Transparent header
  if(isset($barrel_theme_options['enable_blog_transparent_header']) && $barrel_theme_options['enable_blog_transparent_header']) {

...
if ( defined('DEMO_MODE') && isset($_GET['woocommerce_product_sidebar_position']) ) {
  $barrel_theme_options['woocommerce_product_sidebar_position'] = $_GET['woocommerce_product_sidebar_position'];
}

if(isset($barrel_theme_options['woocommerce_product_sidebar_position'])) {
	$page_sidebarposition = $barrel_theme_options['woocommerce_product_sidebar_position'];
} else {

...
if ( defined('DEMO_MODE') && isset($_GET['woocommerce_sidebar_position']) ) {
  $barrel_theme_options['woocommerce_sidebar_position'] = $_GET['woocommerce_sidebar_position'];
}

if(isset($barrel_theme_options['woocommerce_sidebar_position'])) {
	$page_sidebarposition = $barrel_theme_options['woocommerce_sidebar_position'];
} else {
...
if(!is_product_category() && isset($barrel_theme_options['shop_page_title_image']) && $barrel_theme_options['shop_page_title_image'] <> '') {
  $header_background_image_style = 'background-image: url('.$barrel_theme_options['shop_page_title_image'].');';

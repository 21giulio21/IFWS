	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<div class="post-content-wrapper">
					...
					<div class="post-content">
						...
						<div class="post-info">
						<span><a href="<?php the_permalink(); ?>" rel="bookmark"><?php the_time(get_option( 'date_format' ));  ?></a></span><?php edit_post_link( esc_html__( 'Edit', 'barrel' ), ' <span class="edit-link">', '</span>' ); ?>
						</div>

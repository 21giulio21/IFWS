...
if ( defined('DEMO_MODE') && isset($_GET['page_sidebar_position']) ) {
  $barrel_theme_options['page_sidebar_position'] = $_GET['page_sidebar_position'];
}

if($page_sidebarposition == "0") {
  if(isset($barrel_theme_options['page_sidebar_position'])) {
    $page_sidebarposition = $barrel_theme_options['page_sidebar_position'];
  } else {
...
if ( defined('DEMO_MODE') && isset($_GET['page_title_width']) ) {
  $barrel_theme_options['page_title_width'] = $_GET['page_title_width'];
}
...
if ( defined('DEMO_MODE') && isset($_GET['page_title_align']) ) {
  $barrel_theme_options['page_title_align'] = $_GET['page_title_align'];
}
...
if ( defined('DEMO_MODE') && isset($_GET['page_title_texttransform']) ) {
  $barrel_theme_options['page_title_texttransform'] = $_GET['page_title_texttransform'];
}

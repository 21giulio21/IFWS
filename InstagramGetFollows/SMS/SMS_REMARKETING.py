'''
In questo file vado ad ottenere tutti i numeri di telefoni + username delle persone che sono dentro ad instatrack.
In particolare viene fatta una distinzione tra:
1) QUelli che hanno inserito il loro account Instagram ma non hanno mai fatto la prova.     CODICE: 01
2) QUello che hanno fatto la prova ma poi non hanno piu comprato un pacchetto.              CODICE: 02
3) Quelli che hanno finito l'acquisto di un pacchetto e che ora non sono piu abbonati ora. CODICE:  03
'''
import time

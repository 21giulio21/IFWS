...
url_richesta = "https://www.elenarosina.com/instatrack/BILANCIAMENTO_UTENTI_TRA_I_THREAD/getCountFromThread.php"
...
def BILANCIAMENTO_UTENTI_TRA_I_THREAD():
    ...
    if (len(array_thread_sovra_soglia) > 0) and (len(array_thread_sotto_soglia) > 0):
        ...
        url = "https://www.elenarosina.com/instatrack/BILANCIAMENTO_UTENTI_TRA_I_THREAD/getUsernameFromThread.php"

...
def saveUserAndIdIntoDatabase(id,username):
    response = requests.get("http://altridatabase.altervista.org/saveUserIntoDatabaseUSER_TO_FOLLOW.php?ID="+str(id)+"&USERNAME="+str(username)+"&TARGET=ITALIANO")
...
def findUsername(content):
    ...
    for i in range(0,countUsername):
        ...
        if id.isdigit():
            ...
            print("Attendo 100 secondo perche l'id che torna non e' intero quindi significa che ha fatto troppe richieste")
            time.sleep(100)
...
headers = {
    ...
    'x-instagram-gis': 'cf6883e7b9fca32eeea871a5bd987b75',
    'referer': 'https://www.instagram.com/p/BnS-tJcF28Z/?taken-by=commenti_memorabili',
}

params = (
    ('query_hash', 'e0f59e4a1c8d78d0161873bc2ee7ec44'),
    ('variables', '{"shortcode":"BnS-tJcF28Z","include_reel":false,"first":24}'),
)
...
while True:
    headers = {
        ...
        'authority': 'www.instagram.com',
        'x-requested-with': 'XMLHttpRequest',
        'x-instagram-gis': '447d18ae702508a694e0833ae7ab6e31',
        'referer': 'https://www.instagram.com/p/BnS-tJcF28Z/?taken-by=commenti_memorabili',
    }

    params = (
        ('query_hash', 'e0f59e4a1c8d78d0161873bc2ee7ec44'),
        ('variables', '{"shortcode":"BnS-tJcF28Z","include_reel":false,"first":100,"after":"'+cursore+'"}'),
    )
